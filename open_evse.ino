...
void TempMonitor::Init()
{
  ...
  m_TMP007_temperature = 0;     //bhc  was 230?
...
void DelayTimer::CheckTime()
{
  if (!g_EvseController.InFaultState() &&
    ...
    if ((g_EvseController.GetState() == EVSE_STATE_SLEEPING) && !g_EvseController.LimitSleepIsSet()) { //bhc
	    g_EvseController.Enable();
	  }           
	}
	else {
      ...
      g_EvseController.SetLimitSleep(0);  // clear sleep flag caused by limit tripped //bhc      
	    g_EvseController.Sleep();   
	  }
	}
      }
